...
import CharsetRule = require('../../../../lib/rules/CharsetRule');
...
describe('charset rule', () => {
	...
	describe('check command', () => {
		...
		it('reports out of range characters for "latin1" setting', () => {
			...
			//expect(report).to.have.been.calledWithExactly('Character out of latin1 range: \u0080');
		});
		...
		it('reports invalid charsets', () => {
			...
			//expect(report).to.have.been.calledOnce;
			//expect(report).to.have.been.calledWithExactly('Invalid charset: utf-8-bom');
		});
